...
def solution(s):
    ...
    if len(ind_odd) == 0: ind_odd.append(0)  # 나머지 2개이상 문자열(모든 글자가 다르거나, 팰린드롬이 없거나) 
...
# 테스트 케이스: "abcdcba", "abacde", "cdaade", "abcdcbajklml", "zxxzabcdcbajklmlcdaad", "a", "abcde"
# "a"와 "abcde", "lacl" 모두 결과가 1이 나와야 함.    